function [obj] = sensor_kinematics(obj)
    
    % Deconstruct obj class
    k           = obj.spring_k;
    p           = obj.p;
    l           = obj.links;
    alpha       = obj.alpha;
    ...
    % obj.prev_direc(ctr,:) = delta;

     % obj.direction = mean(obj.prev_direc); % Rolling average of past n samples
    obj.direction = delta;
    obj.force = force;
    obj.p = p;             % ONLY USED FOR 'LIVE' PLOT
