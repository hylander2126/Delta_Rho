...
comLines = 1000000*measuredCoM;

% Inputs
L1x = [a_p_init(1,1) comLines(1,1)]; 
L1y = [a_p_init(1,2) comLines(1,2)];
L2x = [a_p_init(2,1) comLines(2,1)]; 
L2y = [a_p_init(2,2) comLines(2,2)];
showIntersectionPlot = 0;
% Function callback
[comX, comY] = linexline(L1x, L1y, L2x, L2y, showIntersectionPlot);

finalCoMPrediction = round([comX, comY], 3)
