%% Demo for co-manipulation with human-in-the-loop for SINGLE ROBOT with attitude correction

% Need to make sure that robot firmware has attitude correction enabled.
