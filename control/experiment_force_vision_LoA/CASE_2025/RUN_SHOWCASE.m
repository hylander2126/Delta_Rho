...
% ====================================================================
DATE = '03-10-25';
filePath = [DATE, '_showcase_com2_unknown_box'];
...
while (t < run_time  &&  ~robots.stop)
    ...
    if ~baseline
        ...
        [robots, force_sensors] = update_robots_showCASE(s1, N, robots, force_sensors);
...
savePath = ['CASE_2025\showCASE_', DATE, '\' filePath, '.mat'];
