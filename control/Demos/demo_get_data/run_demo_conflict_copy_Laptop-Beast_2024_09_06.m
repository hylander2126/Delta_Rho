...
%% Open SerialPort 
s1 = serialport('COM4',9600,'DataBits',8,'StopBits',1); % COM3 for Desktop
s1.Timeout = .15;
...
switchMode(IDs(1), s1);     % Switch to motion mode
for i=1:N
...
f1 = figure("Position", [600 300 700 400]); hold on; % [600 300 800 500]); hold on;
